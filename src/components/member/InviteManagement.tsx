...
export default function InviteManagement({
  ...
  const handleSendInvitation = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.ok) {
        setSuccessMessage(
          `Invitation sent successfully to ${inviteForm.firstName} ${inviteForm.lastName}!`
        );
          ...
          <form onSubmit={handleSendInvitation} className='space-y-4'>
            ...
            <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
              ...
              <div className='text-sm text-yellow-700 bg-white p-3 rounded border'>
                <p>
                  <strong>Hello {inviteForm.firstName || '[First]'}!</strong>
                </p>
                <p>
                  Am I Human?? Great question huh! Truth: I want to connect to
                  the people I love. That's you! This is a private space, no
                  ads, no bots, no censorship...just people I love!! Check it
                  out and join me!!
                </p>
                <p>
                  Talk soon,
                      ...
                      <div className='flex items-center space-x-3 mb-2'>
                        <div className='w-8 h-8 bg-green-100 rounded-full flex items-center justify-center'>
                          <span className='text-green-600 font-semibold text-sm'>
                            {invite.firstName?.charAt(0)}
                            {invite.lastName?.charAt(0)}
                          </span>
                        </div>
                        <div>
