...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!nfSnapshot.empty) {
      ...
      console.log('[ADMIN-SEND-INVITATION] ⚡ MATCH FOUND in notFoundRegistry:', nfDoc.id);
      ...
      console.log('[ADMIN-SEND-INVITATION] ✅ Updated notFoundRegistry status to "invited"');
    } else {
