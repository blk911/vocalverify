  ...
  try {
    ...
    if (nameLower) {
      ...
      if (!nfSnapshot.empty) {
        ...
        console.log('[MEMBER-SEND-INVITATION] ⚡ MATCH FOUND in notFoundRegistry:', nfDoc.id);
        ...
        console.log('[MEMBER-SEND-INVITATION] ✅ Updated notFoundRegistry status to "invited"');
      }
    }
