        ...
        <main className='flex-1'>
          ...
          <div className='p-6'>
            <div className='bg-white rounded-xl border border-slate-200 p-6'>
              <h2 className='text-xl font-semibold text-slate-800 mb-4'>Profile Content</h2>
              <p className='text-slate-600'>This is your Profile page content.</p>
            </div>
          </div>
        </main>
      </div>
