        ...
        <main className='flex-1'>
          ...
          <div className='bg-white border-b border-slate-200 px-6 py-3'>
            <div className='flex items-center space-x-6'>
              ...
              <button
                className='px-4 py-2 rounded-lg font-medium transition-colors bg-blue-100 text-blue-700 border border-blue-200'
              >
                NETWORK
              </button>
            </div>
          ...
          <div className='p-6'>
            ...
            <div className='mb-6'>
              ...
              <p className="text-sm text-gray-500">Your trust architecture: Bonds and Units.</p>
            </div>
            ...
            <div className='space-y-6'>
              ...
              <div className='bg-white rounded-xl border border-slate-200 p-6'>
                ...
                <TrustNetworkManager memberCode={memberCode} />
              </div>
            </div>
          </div>
        </main>
