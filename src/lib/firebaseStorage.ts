 ...
 */
export const uploadQRCode = async (inviteId: string, qrCodeBuffer: Buffer): Promise<string> => {
  try {
    ...
    console.log(`[FIREBASE-STORAGE] ✅ QR code uploaded successfully: ${downloadURL}`);
    return downloadURL;
